...
function page() {
  return (
    <div className="w-full h-full dark:bg-[#3E3E3E] flex flex-col gap-3">
      ...
      <div className="p-12  w-full">
        <div className="border rounded-md pl-6 border-slate-300 dark:text-black bg-slate-100 shadow-sm pr-6 p-3 grid grid-cols-5 justify-between">
