...
export default function page() {
  return (
    <div className="flex flex-col w-full bg-[#3E3E3E] justify-center items-center">
      <div className="w-full flex sm:flex-row flex-col justify-around p-10 items-center">
        ...
        <div className=" border p-6 bg-slate-100 gap-3 h-84  dark:text-black flex flex-col justify-start border-gray-200 min-w-88 shadow-md rounded-md">
      ...
      <div className="p-12 max-w-5xl w-full">
        <div className="border rounded-md pl-6 dark:text-black border-slate-300 bg-slate-100 shadow-sm pr-6 p-3 flex justify-between">
