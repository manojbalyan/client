...
export default function page() {
  return (
    <div className="flex flex-col dark:bg-[#3E3E3E] w-full justify-center items-center">
      <div className="w-full flex sm:flex-row flex-col justify-around p-10 items-center">
        ...
        <div className=" border p-6 bg-slate-100 gap-3 h-84  flex flex-col justify-start dark:text-black border-gray-200 min-w-88 shadow-md rounded-md">
