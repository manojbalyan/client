...
function page() {
  return (
    <div className="h-screen w-screen flex fixed justify-center items-center bg-gradient-to-br from-blue-300 to-cyan-200">
      <div className=" border border-gray-300 flex flex-col shadow-xl rounded-lg sm:gap-4 gap-3 pl-24 pr-24 p-20 bg-white">
        ...
        <div className="flex flex-col gap-2 pt-5">
          ...
          <input
            ...
            className="pl-3 pr-3 p-2 border sm:w-80 border-gray-200 rounded-md"
          />
        </div>
        <div className="flex flex-col gap-2">
          ...
          <input
            ...
            className="pl-3 pr-3 p-2 border border-gray-200 rounded-md"
          />
        </div>
        <div className="flex flex-col gap-2">
          <label
